...
internal fun buildLedgerBackupJson(
    ...
    appendJsonArray("billOccurrences", billOccurrences.map { it.toBackupJson() }, trailingComma = false)
    appendLine("}")
}
...
private fun IncomeEntity.toBackupJson(): String = buildString {
    ...
    appendJsonNumberField("expectedAmountCents", expectedAmountCents, indent = "    ", trailingComma = false)
    append("  }")
}
